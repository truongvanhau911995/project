    ...
    if (empty($_SESSION['captcha']) || trim(strtolower($_POST['txtCaptcha'])) != $_SESSION['captcha']) {
        ...
        // echo $str_dob;
            ...
            if ($enc_pwd == $MKMOI) {
                ...
                $sql = "insert into taikhoan(TenDN, MatKhau, TenHienThi,DiaChi,DienThoai, Email, DOB, MaLoaiTK) values('$uid', '$enc_pwd', '$fullname','$diachi','$dienthoai', '$email', '$str_dob', 0)";
