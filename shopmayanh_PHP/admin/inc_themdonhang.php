...
if(isset($_POST["btnInsert"]))	
{
	...
	$tongtien=$gia*$sl;
	 ...
	 $sql = "insert into orderdetails (OrderID,ProID,Quantity, Price, Amount) values('$name','$idsp','$sl','$gia','$tongtien')";
        $id = save($sql, 0);
       // echo $id;
...
<div class="col-md-9">
    <div class="panel panel-default" style="height: 324px;">
        <div class="panel-heading" style="background-color:#333;margin-bottom: 20px;">
            <h3 class="panel-title" style="color:#9d9d9d;">Thêm đơn hàng</h3>
        </div>
...
<form class="form-horizontal" action="" method="post" id="InsertForm" onsubmit="return validate();">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="form-group">
                            <div class="input-group">
								<span class="input-group-addon" id="basic-addon1">ID khách hàng: </span>
                                <input  type="text" class="form-control" name="txtKH" placeholder="ID khách hàng">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="form-group">
                            <div class="input-group">
								<span class="input-group-addon" id="basic-addon1">ID sản phẩm: </span>
                                <input  type="text" class="form-control" name="txtSP" placeholder="ID sản phẩm">
                            </div>
						</div>
                        <div class="form-group">
                            <div class="input-group">
								<span class="input-group-addon" id="basic-addon1">Số lượng: </span>
                                <input  type="text" class="form-control" name="txtSL" placeholder="Số lượng">
                            </div>
						</div>
						<div class="form-group">
                            <div class="input-group">    
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-2">
								<a class="btn btn-danger" href="admin.php?act=quanlydonhang" role="button">
