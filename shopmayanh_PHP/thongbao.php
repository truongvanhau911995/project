...
<div class="col-md-9">
    <div class="panel panel-default">
        ...
        <div class="panel-heading" style="background-color: #FFCCCC">
            <h3 class="panel-title" style="color: blue; text-align: center">10 SẢN PHẨM MỚI NHẤT NHẤT <img src="images/new.gif" alt="..."></h3>
        </div>
...
<?php
include_once "SPBanChay.php";
include_once "SPXemNhieu.php";
